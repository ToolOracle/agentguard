...
TOOL_RISK = {
    ...
    # === AmpelOracle DORA Tools (added 2026-03-29) ===
    # Read-only assessment/status
    "readiness_check": 5, "article_status": 5, "gap_report": 5,
    "evidence_summary": 5, "entity_list": 5, "freshness_check": 5,
    "bridge_report": 5, "bridge_status": 5, "bus_status": 5,
    "audit_trail": 8, "evidence_pack": 8, "score_trend": 5,
    "escalation_status": 8, "board_summary": 10,
    # Dependency/risk analysis (read-only but sensitive data)
    "dependency_graph": 10, "whatif_provider": 10, "whatif_stale": 10,
    "provider_country_risk": 10, "regulation_impact": 5,
    # Evidence collection (external API calls)
    "collect_art10": 20, "reg_watchdog": 15,
    "azure_ad_check": 25, "servicenow_sync": 25,
    "cve_asset_map": 20, "cross_regulation_check": 15,
    # Write operations (state changes)
    "create_entity": 50, "onboard_entity": 55,
    "register_provider": 55, "assess_all": 45,
    "update_finding": 40, "retest_finding": 35,
    "run_escalation": 45,
    # Contract pipeline (sensitive documents)
    "contract_upload": 50, "contract_analyze": 35,
    "contract_status": 10, "check_contract": 15,
    "llm_clause_check": 30,
    # Bridge/approval (requires authority)
    "bridge_resolve": 60, "bridge_approve": 65,
    "bafin_report_draft": 55, "bafin_approve_send": 75,
    # Policy drafting
    "policy_draft": 40,
    # Incident (sensitive)
    "incident_flow": 55, "generate_report": 30,
    # === OECDOracle Tools (added 2026-03-29) ===
    "oecd_gdp": 5, "oecd_unemployment": 5, "oecd_cli": 5,
    "oecd_cpi": 5, "oecd_interest_rates": 5,
    "oecd_country_compare": 5, "oecd_country_profile": 8,
    "oecd_g7_dashboard": 5, "oecd_eu_dashboard": 5,
    "oecd_search": 5, "oecd_indicator_info": 5,
    # === MiCAOracle Tools ===
    "mica_readiness": 5, "mica_article_status": 5,
    "mica_token_check": 10, "mica_issuer_profile": 10,
    "mica_bridge_resolve": 60, "mica_bridge_approve": 65,
    # === AMLOracle Tools ===
    "sanctions_screen": 20, "pep_check": 20,
    "kyc_bundle": 25, "adverse_media": 15,
    "transaction_risk": 25, "watchlist_update": 30,
    # === ResearchOracle ===
    "search_papers": 8, "search_arxiv": 8, "paper_details": 5,
    # === ESMAOracle ===
    "esma_casp_search": 5, "esma_whitepaper": 5,
    # === EULawOracle ===
    "eulaw_search": 5, "eulaw_article": 5,
    # === RegWatchOracle ===
    "regwatch_latest": 5, "regwatch_search": 5,
    # === TestOracle Tools (added 2026-03-31) ===
    "create_test_programme": 30, "schedule_test": 25, "complete_test": 25,
    "test_coverage": 5, "overdue_tests": 5, "scenario_library": 5,
    "tester_qualification": 5, "tlpt_status": 5, "evidence_pack": 8,
    "test_timeline": 5, "obligation_map": 5, "sync_to_ampel": 35,
    # === ReportingOracle Tools (added 2026-03-31) ===
    "incident_report": 45, "incident_status": 5, "roi_export": 25,
    "roi_validate": 10, "tlpt_report": 25, "annual_report": 25,
    "management_letter": 30, "nca_submission_status": 5,
    "deadline_tracker": 5, "report_templates": 5, "sync_from_ampel": 15,
    # === CloudOracle Tools (added 2026-03-31) ===
    "cloud_status": 5, "cloud_incidents": 5, "region_status": 5,
    "saas_status": 5, "concentration_risk": 10, "sla_check": 10,
    "provider_dashboard": 8, "outage_impact": 15, "ctpp_check": 5,
    "notification_check": 10,
    # === Conductor Tools (added 2026-03-31) ===
    "full_assessment": 15, "readiness_dashboard": 5, "run_workflow": 25,
    "plan_remediation": 15, "react_to_event": 30, "sync_all": 35,
    "gap_analysis": 10, "board_briefing": 10, "nca_readiness": 10,
    "onboard_entity": 55, "daily_check": 20, "workflow_library": 5,
    "oracle_status": 5, "obligation_overview": 5,
    # === DriftOracle Tools (added 2026-03-31) ===
    "detect_regulatory_drift": 10, "detect_evidence_drift": 10,
    "detect_cloud_drift": 10, "detect_control_drift": 10,
    "full_drift_scan": 15, "drift_status": 5, "mark_drift": 25,
    "resolve_drift": 25, "trigger_remediation": 40,
    "drift_history": 5, "configure_thresholds": 20,
    # === EventFabric Tools (added 2026-03-31) ===
    "emit_event": 25, "subscribe": 20, "unsubscribe": 15,
    "list_subscriptions": 5, "event_log": 5, "event_stats": 5,
    "active_rules": 5, "create_rule": 30, "test_webhook": 15,
    "schedule_scan": 25, "list_schedules": 5, "webhook_status": 5,
    # === PredictOracle Tools (added 2026-03-31) ===
    "predict_entity": 10, "predict_article": 8, "predict_score": 10,
    "risk_forecast": 8, "evidence_decay": 5, "deadline_risk": 5,
    "remediation_velocity": 5, "trend_analysis": 5,
    "early_warning": 8, "scenario_forecast": 8,
    # === ZKEvidenceOracle Tools (added 2026-03-31) ===
    "create_commitment": 15, "verify_commitment": 5,
    "build_merkle_tree": 15, "verify_merkle_proof": 5,
    "create_vc": 20, "verify_vc": 5, "privacy_report": 10,
    "selective_disclosure": 10, "anchor_status": 5,
    "audit_proof": 25, "threshold_proof": 10, "obligation_proof": 10,
    # === TLPTOracle v2 Tools (added 2026-03-31) ===
    "auto_simulate": 35, "mitre_map": 5, "attack_chain": 8,
    "generate_scenarios": 5, "register_exercise": 30,
    "phase_tracker": 10, "threat_profile": 15, "team_assignment": 20,
    "finding_register": 35, "remediation_plan": 25,
    "test_calendar": 5, "tlpt_readiness": 8,
    # === TrainingOracle v2 Tools (added 2026-03-31) ===
    "register_training": 25, "log_completion": 20, "board_training": 5,
    "role_requirements": 15, "compliance_check": 5, "gap_report": 5,
    "phishing_results": 5, "dora_programmes": 5,
    # === PolicyOracle v2 Tools (added 2026-03-31) ===
    "register_policy": 30, "list_policies": 5, "policy_gap_check": 5,
    "review_schedule": 5, "approval_tracker": 5, "coverage_map": 5,
    "version_control": 15, "attestation": 20, "compliance_score": 5,
    # === MEGA MCP Enterprise Extension Tools (added 2026-04-01) ===
    # --- CFOCoPilot (Port 12201) ---
    "vat_validate": 10, "vat_rates": 5, "iban_validate": 10,
    "tax_calendar_de": 5, "invoice_generate": 35, "invoice_validate_xr": 15,
    "reverse_charge_check": 10, "dunning_generate": 40, "credit_note_generate": 35,
    "fx_rates": 5, "cashflow_forecast": 10, "financial_kpis": 10,
    # --- HROracle (Port 12301) ---
    "gross_to_net": 10, "employer_cost": 10, "minijob_check": 5,
    "leave_calculate": 5, "notice_period": 5, "working_time_check": 5,
    "parental_leave_check": 5, "contract_clauses": 10, "onboarding_checklist": 5,
    "offboarding_checklist": 15, "skills_gap_analyze": 10, "headcount_forecast": 10,
    # --- HealthGuard (Port 12401) ---
    "mdr_compliance_check": 15, "ivdr_check": 15, "device_classification": 10,
    "udi_validate": 10, "drug_interaction": 20, "icd10_lookup": 5,
    "adverse_event_report": 30, "gdpr_health_check": 20, "hipaa_vs_gdpr": 5,
    "clinical_trial_phases": 10, "gmp_checklist": 10, "medical_calendar_eu": 5,
    # --- SupplyChainOracle (Port 12501) ---
    "supplier_risk_score": 15, "concentration_risk": 10, "disruption_detector": 15,
    "geopolitical_risk": 10, "lksg_check": 20, "scope3_estimate": 15,
    "csrd_supply_check": 15, "cbam_check": 15, "lead_time_calc": 5,
    "total_cost_ownership": 10, "customs_hs_lookup": 5, "incoterms_guide": 5,
    # --- CyberShield (Port 12601) ---
    "threat_landscape": 10, "cve_risk_score": 15, "attack_surface_check": 20,
    "phishing_indicators": 15, "nis2_compliance": 15, "nis2_incident_report": 30,
    "iso27001_gap": 15, "dora_ict_risk": 15, "password_policy": 10,
    "incident_playbook": 20, "risk_matrix": 10, "security_metrics": 10,
    # --- LegalTechOracle (Port 12701) ---
    "contract_draft": 40, "nda_generate": 35, "freelancer_contract": 35,
    "dpa_generate": 35, "clause_risk_scan": 15, "contract_summary": 10,
    "termination_analysis": 10, "obligation_matrix": 10, "cross_jurisdiction": 10,
    "regulatory_clause_check": 15, "force_majeure_check": 10, "liability_cap_check": 10,
    # --- TaxOracle (Port 12801) ---
    "dac6_assessment": 25, "pillar_two_calc": 20, "transfer_pricing": 20,
    "withholding_tax": 10, "pe_risk_check": 15, "ust_voranmeldung": 25,
    "trade_tax_calc": 15, "betriebspruefung": 10, "gaap_ifrs_diff": 5,
    "depreciation_calc": 5, "r_and_d_incentive": 10, "tax_loss_carryforward": 15,
    # === DORA OS v2.0 New Tools (added 2026-04-01) ===
    "cross_oracle_assess": 30, "detect_enterprise_drift": 20,
...
TOOL_SCOPES = {
    ...
    # === DORA OS Oracles — Tool Scopes (added 2026-03-31) ===
    # TestOracle — compliance domain
    "create_test_programme": "compliance:write", "schedule_test": "compliance:write",
    "complete_test": "compliance:write", "test_coverage": "compliance:read",
    "overdue_tests": "compliance:read", "scenario_library": None,
    "tester_qualification": "compliance:read", "tlpt_status": "compliance:read",
    "sync_to_ampel": "compliance:write",
    # ReportingOracle — compliance domain
    "incident_report": "compliance:write", "incident_status": "compliance:read",
    "roi_export": "compliance:read", "roi_validate": "compliance:read",
    "tlpt_report": "compliance:read", "annual_report": "compliance:read",
    "management_letter": "compliance:write", "nca_submission_status": "compliance:read",
    "deadline_tracker": None, "report_templates": None,
    "sync_from_ampel": "compliance:read",
    # CloudOracle — monitoring domain
    "cloud_status": None, "cloud_incidents": None, "region_status": None,
    "saas_status": None, "concentration_risk": "compliance:read",
    "sla_check": "compliance:read", "provider_dashboard": "compliance:read",
    "outage_impact": "compliance:read", "ctpp_check": None,
    "notification_check": "compliance:read",
    # Conductor — admin/compliance domain
    "full_assessment": "compliance:read", "readiness_dashboard": "compliance:read",
    "run_workflow": "compliance:write", "plan_remediation": "compliance:read",
    "react_to_event": "compliance:write", "sync_all": "compliance:write",
    "gap_analysis": "compliance:read", "board_briefing": "compliance:read",
    "nca_readiness": "compliance:read", "daily_check": "compliance:read",
    "workflow_library": None, "oracle_status": None,
    "obligation_overview": None,
    # DriftOracle — monitoring/compliance
    "detect_regulatory_drift": "compliance:read",
    "detect_evidence_drift": "compliance:read",
    "detect_cloud_drift": "compliance:read",
    "detect_control_drift": "compliance:read",
    "full_drift_scan": "compliance:read", "drift_status": "compliance:read",
    "mark_drift": "compliance:write", "resolve_drift": "compliance:write",
    "trigger_remediation": "compliance:write",
    "drift_history": "audit:read", "configure_thresholds": "tenant:admin",
    # EventFabric — event processing
    "emit_event": "compliance:write", "subscribe": "compliance:write",
    "unsubscribe": "compliance:write", "list_subscriptions": "compliance:read",
    "event_log": "audit:read", "event_stats": "audit:read",
    "active_rules": None, "create_rule": "tenant:admin",
    "test_webhook": "compliance:write", "schedule_scan": "compliance:write",
    "list_schedules": "compliance:read", "webhook_status": None,
    # PredictOracle — read-only analytics
    "predict_entity": "compliance:read", "predict_article": "compliance:read",
    "predict_score": "compliance:read", "risk_forecast": "compliance:read",
    "evidence_decay": "compliance:read", "deadline_risk": None,
    "remediation_velocity": "compliance:read", "trend_analysis": "audit:read",
    "early_warning": "compliance:read", "scenario_forecast": "compliance:read",
    # ZKEvidenceOracle — crypto/privacy
    "create_commitment": "compliance:write", "verify_commitment": None,
    "build_merkle_tree": "compliance:write", "verify_merkle_proof": None,
    "create_vc": "compliance:write", "verify_vc": None,
    "privacy_report": "compliance:read", "selective_disclosure": "compliance:read",
    "anchor_status": None, "audit_proof": "compliance:read",
    "threshold_proof": None, "obligation_proof": None,
    # TLPTOracle v2 — testing
    "auto_simulate": "compliance:write", "mitre_map": None,
    "attack_chain": None, "generate_scenarios": None,
    "register_exercise": "compliance:write", "phase_tracker": "compliance:read",
    "threat_profile": "compliance:read", "team_assignment": "compliance:write",
    "finding_register": "compliance:write", "remediation_plan": "compliance:write",
    "test_calendar": "compliance:read", "tlpt_readiness": "compliance:read",
    # TrainingOracle v2
    "register_training": "compliance:write", "log_completion": "compliance:write",
    "board_training": "compliance:read", "role_requirements": "compliance:read",
    "phishing_results": "compliance:read", "dora_programmes": None,
    # === MEGA MCP Enterprise Extension — Tool Scopes (added 2026-04-01) ===
    # CFOCoPilot — finance:read/write
    "vat_validate": "finance:read", "vat_rates": None, "iban_validate": "finance:read",
    "tax_calendar_de": None, "invoice_generate": "finance:write", "invoice_validate_xr": "finance:read",
    "reverse_charge_check": "finance:read", "dunning_generate": "finance:write", "credit_note_generate": "finance:write",
    "fx_rates": None, "cashflow_forecast": "finance:read", "financial_kpis": "finance:read",
    # HROracle — hr:read/write
    "gross_to_net": "hr:read", "employer_cost": "hr:read", "minijob_check": None,
    "leave_calculate": "hr:read", "notice_period": None, "working_time_check": None,
    "parental_leave_check": "hr:read", "contract_clauses": "hr:read", "onboarding_checklist": "hr:read",
    "offboarding_checklist": "hr:write", "skills_gap_analyze": "hr:read", "headcount_forecast": "hr:read",
    # HealthGuard — healthcare:read/write
    "mdr_compliance_check": "healthcare:read", "ivdr_check": "healthcare:read", "device_classification": "healthcare:read",
    "udi_validate": "healthcare:read", "drug_interaction": "healthcare:read", "icd10_lookup": None,
    "adverse_event_report": "healthcare:write", "gdpr_health_check": "compliance:read", "hipaa_vs_gdpr": None,
    "clinical_trial_phases": "healthcare:read", "gmp_checklist": "healthcare:read", "medical_calendar_eu": None,
    # SupplyChainOracle — supplychain:read/write
    "supplier_risk_score": "supplychain:read", "disruption_detector": "supplychain:read",
    "geopolitical_risk": None, "lksg_check": "compliance:read", "scope3_estimate": "supplychain:read",
    "csrd_supply_check": "compliance:read", "cbam_check": "supplychain:read", "lead_time_calc": None,
    "total_cost_ownership": "supplychain:read", "customs_hs_lookup": None, "incoterms_guide": None,
    # CyberShield — security:read/write
    "threat_landscape": "security:read", "cve_risk_score": "security:read", "attack_surface_check": "security:read",
    "phishing_indicators": "security:read", "nis2_compliance": "compliance:read", "nis2_incident_report": "security:write",
    "iso27001_gap": "compliance:read", "dora_ict_risk": "compliance:read", "password_policy": "security:read",
    "incident_playbook": "security:read", "risk_matrix": "security:read", "security_metrics": "security:read",
    # LegalTechOracle — legal:read/write
    "contract_draft": "legal:write", "nda_generate": "legal:write", "freelancer_contract": "legal:write",
    "dpa_generate": "legal:write", "clause_risk_scan": "legal:read", "contract_summary": "legal:read",
    "termination_analysis": "legal:read", "obligation_matrix": "compliance:read", "cross_jurisdiction": "legal:read",
    "regulatory_clause_check": "compliance:read", "force_majeure_check": "legal:read", "liability_cap_check": "legal:read",
    # TaxOracle — tax:read/write
    "dac6_assessment": "tax:read", "pillar_two_calc": "tax:read", "transfer_pricing": "tax:read",
    "withholding_tax": "tax:read", "pe_risk_check": "tax:read", "ust_voranmeldung": "tax:write",
    "trade_tax_calc": "tax:read", "betriebspruefung": "tax:read", "gaap_ifrs_diff": None,
    "depreciation_calc": "tax:read", "r_and_d_incentive": "tax:read", "tax_loss_carryforward": "tax:read",
    # DORA OS v2.0
    "cross_oracle_assess": "compliance:write", "detect_enterprise_drift": "compliance:read",
    # PolicyOracle v2
    "register_policy": "compliance:write", "list_policies": "compliance:read",
    "policy_gap_check": "compliance:read", "review_schedule": "compliance:read",
    "approval_tracker": "compliance:read", "coverage_map": "compliance:read",
    "version_control": "compliance:write", "attestation": "compliance:write",
    "compliance_score": "compliance:read",
...
async def handle_tenant_policy_check(args: dict) -> dict:
    ...
    TENANT_CONFIGS = {
        ...
        "fintech_eu": {
            ...
            "compliance_frameworks": ["MiCA", "DORA", "AMLD6", "NIS2", "LkSG", "ISO27001", "CSRD", "DAC6", "EU_MDR"],
        ...
        "enterprise_compliance": {
            "name": "Enterprise Compliance Tenant",
            "allowed_tools": None,
            "blocked_tools": [],
            "max_risk_score": 50,
            "requires_mfa_above": 30,
            "spend_limit_per_day": 1_000_000,
            "compliance_frameworks": ["DORA", "MiCA", "NIS2", "LkSG", "ISO27001", "CSRD", "DAC6", "EU_MDR", "GDPR", "XRechnung"],
            "rate_limit_per_minute": 1000,
            "required_scopes": ["compliance:read"],
        },
        "enterprise_read": {
